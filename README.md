...
This repo also includes a lightweight text-to-video localization pipeline,
extended from REN, that indexes video frames with CLIP and localizes object
occurrences with SAM2. It is intended for quick experimentation on datasets
like EPIC-KITCHENS and Ego4D.
